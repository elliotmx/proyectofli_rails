...
ProjectScope.create(:description => "Un grupo específico de personas con requisitos particulares.")
ProjectScope.create(:description => "Varios grupos de personas con los mismos problemas y necesidades")
ProjectScope.create(:description => "Uno o varios grupos de personas con diferentes problemas y necesidades.")
Market.create(:description => "Automotriz")
#Market.create(:id => 2, :description => "Comunicaciones y Conectividad")
Market.create( :description => "Desarrollo de Software")
Market.create(:description => "Distribución y Venta al por menor")
#Market.create(:id => 5, :description => "Domótica y Hogar Digital")
Market.create( :description => "Educación")
Market.create(:description => "Energía y Ahorro de Energía")
Market.create(:description => "Entretenimiento")
...
Market.create( :description => "Medios de Comunicación y Contenidos")
Market.create( :description => "Moda")
Market.create(:description => "Publicidad")
#Market.create(:id => 20, :description => "RRHH: Empleo y Contratación")
Market.create( :description => "Salud y Bienestar")
Market.create(:description => "Agricultura")
Market.create( :description => "Seguridad")
...
Market.create( :description => "Viajes, Turismo, Hotelería")
Market.create( :description => "Actividades Pecuarias")
Market.create( :description => "Mineria")
Market.create( :description => "Alimentos")
